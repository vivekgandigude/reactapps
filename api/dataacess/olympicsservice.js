...
class OlympicWinnersService {
  ...
  buildSql(request) {
    ...
    const fromSql = " FROM sakila.olympic_winners LIMIT 10 ";
    const SQL = selectSql + fromSql;
    console.log(SQL);
    return SQL;
  }
...
const olympicsservice = new OlympicWinnersService();
export default olympicsservice;
